...
class VideoFileService:
    ...
    def __init__(self, supported_formats: Optional[Set[str]] = None):
        ...
        logger.info(f"VideoFileService initialized with formats: {self.supported_formats}")
    ...
    def get_video_file_info(self, file_path: Union[str, Path]) -> Optional[VideoFileInfo]:
        """
    ...
    def get_video_files_summary(self, video_files: List[Path]) -> Dict[str, Any]:
        ...
        for file_path in video_files:
            ...
            if file_info:
                ...
                format_counts[file_info.extension] = format_counts.get(file_info.extension, 0) + 1
    ...
    def _find_video_files_in_directory(self, directory: Path) -> List[Path]:
        ...
        for suffix in self.supported_formats:
            ...
            video_files.extend(directory.glob(f"*{suffix.upper()}"))
