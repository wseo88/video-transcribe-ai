...
class SubtitleService:
    ...
    def _format_timestamp(self, seconds: Optional[float], format_type: str = "srt") -> str:
        """
    ...
    def _split_subtitle(self, text: str, max_chars: Optional[int] = None) -> str:
        ...
        for word in words:
            ...
            if current_length + word_length + (1 if current_line else 0) > max_chars and current_line:
    ...
    def _split_at_sentence_end(self, text: str, word_data: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
    ...
    def _create_fallback_cue(self, text: str, existing_cues: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _merge_short_cues(self, cues: List[Dict[str, Any]], min_duration: Optional[float] = None) -> List[Dict[str, Any]]:
        """
    ...
    def _process_segments(self, punct_model: Any, aligned_result: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def write_to_srt(
        ...
        """
        return self.write_subtitles(punct_model, aligned_result, video_name, output_dir, "srt")